...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SeriesData.series_label'
        db.add_column(u'proto_seriesdata', 'series_label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SeriesData.series_label'
        db.delete_column(u'proto_seriesdata', 'series_label')
