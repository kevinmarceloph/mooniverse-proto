...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'proto_tab', (
            ...
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['proto.Page'])),
        ...
        # Changing field 'Page.short_description'
        db.alter_column(u'proto_page', 'short_description', self.gf('django.db.models.fields.TextField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Page.short_description'
        db.alter_column(u'proto_page', 'short_description', self.gf('django.db.models.fields.TextField')(max_length=200))
    ...
    models = {
        ...
        u'proto.tab': {
            ...
            'page': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['proto.Page']"}),
