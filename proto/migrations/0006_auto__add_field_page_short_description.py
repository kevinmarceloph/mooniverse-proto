...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.short_description'
        db.add_column(u'proto_page', 'short_description',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.short_description'
        db.delete_column(u'proto_page', 'short_description')
    ...
    models = {
        ...
        u'proto.page': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'short_description': ('django.db.models.fields.TextField', [], {'max_length': '200', 'blank': 'True'}),
