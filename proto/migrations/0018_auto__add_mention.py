...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'proto_mention', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('update', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'mentions', to=orm['proto.Update'])),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'mentions', to=orm['proto.Page'])),
        ...
        db.send_create_signal(u'proto', ['Mention'])


    def backwards(self, orm):
        # Deleting model 'Mention'
        db.delete_table(u'proto_mention')
