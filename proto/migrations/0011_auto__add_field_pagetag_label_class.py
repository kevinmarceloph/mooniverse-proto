...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageTag.label_class'
        db.add_column(u'proto_pagetag', 'label_class',
                      self.gf('django.db.models.fields.CharField')(default=u'default', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PageTag.label_class'
        db.delete_column(u'proto_pagetag', 'label_class')
